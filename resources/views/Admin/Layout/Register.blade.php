...
<html>
  <head>
    ...
    <title>Login - EmmatShopping</title>
  </head>
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" action="{{ route('admin-registration') }}" method="post" >
          @csrf
          ...
          <div class="row">
            <div class="col-lg-6 col-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="text" autofocus name="name">
              </div>
            </div>
            <div class="col-lg-6 col-12">
              <div class="form-group">
                <label class="control-label">MOBILE</label>
                <input class="form-control" type="number" placeholder="number" autofocus name="mobile">
              </div>
            </div>
          </div>
          <div class="row">
